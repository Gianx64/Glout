    ...
    return (
        <SafeAreaView style={styles.containerShowScreen}>
            <ScrollView>
                ...
                <Text style={{...styles.content}}>Dirección: {route.params.store.address ?? 'No se sabe'}</Text>
                <Text style={{...styles.content}}>Horario: {route.params.store.schedule ?? 'No se sabe'}</Text>
